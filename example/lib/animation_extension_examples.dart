        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: true ? [
              ...
              /// Fade Animation
              Ball(color: Colors.blue).fadeIn(duration: 1000, repeat: true, reverse: true),

              /// Fade Out Animation
              Ball(color: Colors.green).fadeOut(duration: 1000, repeat: true, reverse: true),

              /// Fade In Up Animation
              Ball(color: Colors.yellow).fadeInMoveInBottom(duration: 1000, repeat: true),

              /// Fade In Down Animation
              Ball(color: Colors.purple).fadeInMoveInTop(duration: 1000, repeat: true),

              /// Fade In Left Animation
              Ball(color: Colors.orange).fadeInMoveInLeft(duration: 1000, repeat: true),

              /// Fade In Right Animation
              Ball(color: Colors.pink).fadeInMoveInRight(duration: 1000, repeat: true),
            ],
          ),
        ),
      ),
